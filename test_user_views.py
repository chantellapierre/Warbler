...
class MessageViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.testuser = User.signup(username="tester0",
                                    email="test@test.com",
                                    password="testuser",
                                    image_url=None)
        ...
        self.u4 = User.signup("tester4", "test4@test.com", "password", None)
    ...
    def test_users_search(self):
        with self.client as c:
            ...
            self.assertNotIn("@tester4", str(resp.data))
    ...
    def setup_likes(self):
        ...
        m3 = Message(id=9876, text="Message 3", user_id=self.u1_id)
    ...
    def test_add_like(self):
        m = Message(id=2021, text="Covid is gone", user_id=self.u1_id)
        db.session.add(m)
        db.session.commit()
        ...
        with self.client as c:
            ...
            resp = c.post("/messages/2021/like", follow_redirects=True)
            self.assertEqual(resp.status_code, 200)

            likes = Likes.query.filter(Likes.message_id==2021).all()
    ...
    def test_remove_like(self):
        ...
        m = Message.query.filter(Message.text=="like this message").one()
        ...
        # Now we are sure that testuser likes the message "like this message"
    ...
    def test_unauthenticated_like(self):
        ...
        with self.client as c:
            ...
            self.assertIn("Access denied. You are not authorized.", str(resp.data))
